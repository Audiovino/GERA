...
export const neighborhoodsData = [
  {
    ...
    priceM2: 4000,
    growth: 8,
    image: 'https://audiovino.github.io/imagenes-publicas/public/palermo.png',
    lat: -34.5885,
    lon: -58.4233,
  },
  {
    ...
    priceM2: 3800,
    growth: 5,
    image: 'https://audiovino.github.io/imagenes-publicas/public/belgrano_copia.png',
    lat: -34.562,
    lon: -58.454,
  },
   {
  ...
  },
  {
    ...
    priceM2: 3600,
    growth: 6,
    image: 'https://audiovino.github.io/imagenes-publicas/public/nunez.png',
    lat: -34.545,
    lon: -58.465,
  },
  {
    ...
    priceM2: 2700,
    growth: 5,
    image: 'https://audiovino.github.io/imagenes-publicas/public/villa_crespo.png',
    lat: -34.597,
    lon: -58.446,
  },
  {
    ...
    priceM2: 2500,
    growth: 7,
    image: 'https://audiovino.github.io/imagenes-publicas/public/chacarita_copia.webp',
    lat: -34.585,
    lon: -58.453,
  },
    {
  ...
  },
  {
    ...
    priceM2: 3100,
    growth: 4,
    image: 'https://audiovino.github.io/imagenes-publicas/public/villa_urquiza.png',
    lat: -34.567,
    lon: -58.490,
  },
    {
  ...
  },
  {
    ...
    priceM2: 2900,
    growth: 3,
    image: 'https://audiovino.github.io/imagenes-publicas/public/saavedra.png',
    lat: -34.550,
    lon: -58.495,
  },
  {
    ...
    priceM2: 3000,
    growth: 4,
    image: 'https://audiovino.github.io/imagenes-publicas/public/coghlan_copia.png',
    lat: -34.561,
    lon: -58.481,
  },
];
...
export const pointsOfInterestData: { [key: string]: POI[] } = {
  ...
  chacarita: [
    { name: 'Parque Los Andes', address: 'Av. Corrientes 6300', category: 'culture', lat: -34.593, lon: -58.452, link: '#' },
    { name: 'Cementerio de la Chacarita', address: 'Av. Guzmán 680', category: 'culture', lat: -34.588, lon: -58.460, link: '#' },
    { name: 'Teatro Vorterix', address: 'Av. Federico Lacroze 3455', category: 'culture', lat: -34.584, lon: -58.452, link: 'https://vorterix.com/' },
    { name: 'Mercado de Pulgas Dorrego', address: 'Av. Dorrego 1650', category: 'shopping', lat: -34.582, lon: -58.448, link: '#' },
    { name: 'Estación Federico Lacroze', address: 'Av. Federico Lacroze 4100', category: 'culture', lat: -34.591, lon: -58.456, link: '#' },
    { name: 'Sifón', address: 'Av. Jorge Newbery 3881', category: 'food', lat: -34.583, lon: -58.461, link: '#' },
    { name: 'Anchoita', address: 'Juan Ramírez de Velasco 1520', category: 'food', lat: -34.593, lon: -58.448, link: 'https://www.anchoita.com.ar/' },
    { name: 'Hospital Tornú', address: 'Combatientes de Malvinas 3002', category: 'health', lat: -34.585, lon: -58.472, link: '#' },
    { name: 'Fundación Tzedaká', address: 'Av. Corrientes 5415', category: 'education', lat: -34.600, lon: -58.438, link: 'https://www.tzedaka.org.ar/' },
    { name: 'Club Chacarita Juniors', address: 'Gutiérrez 351', category: 'culture', lat: -34.586, lon: -58.457, link: '#' },
  ],
  colegiales: [
    { name: 'Plaza Mafalda', address: 'Conde 145', category: 'culture', lat: -34.577, lon: -58.451, link: '#' },
    { name: 'Mercado de las Pulgas', address: 'Enrique Martínez 50', category: 'shopping', lat: -34.582, lon: -58.449, link: '#' },
    { name: 'Apu Nena', address: 'Av. Dorrego 1650', category: 'food', lat: -34.581, lon: -58.447, link: '#' },
    { name: 'Teatro Gargantúa', address: 'Jorge Newbery 3563', category: 'culture', lat: -34.582, lon: -58.458, link: '#' },
    { name: 'Sanatorio Colegiales', address: 'Conde 2351', category: 'health', lat: -34.568, lon: -58.462, link: '#' },
    { name: 'Colegio Rudolf Steiner', address: 'Freire 1882', category: 'education', lat: -34.570, lon: -58.458, link: '#' },
    { name: 'Plaza de los Colegiales', address: 'Crámer 600', category: 'culture', lat: -34.578, lon: -58.449, link: '#' },
    { name: 'La Guitarrita', address: 'Cuba 3300', category: 'food', lat: -34.560, lon: -58.462, link: '#' },
    { name: 'Universidad de Belgrano (Anexo)', address: 'Av. Federico Lacroze 1947', category: 'education', lat: -34.574, lon: -58.448, link: '#' },
    { name: 'Estación Colegiales', address: 'Virrey Arredondo 3300', category: 'culture', lat: -34.576, lon: -58.451, link: '#' }
  ],
  saavedra: [
    { name: 'Parque Saavedra', address: 'Av. García del Río 3200', category: 'culture', lat: -34.551, lon: -58.487, link: '#' },
    { name: 'Museo Histórico Saavedra', address: 'Crisólogo Larralde 6309', category: 'culture', lat: -34.549, lon: -58.508, link: '#' },
    { name: 'DOT Baires Shopping', address: 'Vedia 3626', category: 'shopping', lat: -34.544, lon: -58.484, link: 'https://www.dotbaires.com.ar/' },
    { name: 'Puente Saavedra', address: 'Av. Maipú 1', category: 'culture', lat: -34.540, lon: -58.480, link: '#' },
    { name: 'Club Sirio Libanés', address: 'Republiquetas 5340', category: 'culture', lat: -34.558, lon: -58.495, link: '#' },
    { name: 'Rayo de Sol', address: 'Melián 3640', category: 'food', lat: -34.555, lon: -58.488, link: '#' },
    { name: 'CEMIC Saavedra', address: 'Av. E. Galván 4102', category: 'health', lat: -34.563, lon: -58.486, link: 'https://www.cemic.edu.ar/' },
    { name: 'Colegio San Juan el Precursor', address: 'Vilela 2900', category: 'education', lat: -34.558, lon: -58.482, link: '#' },
    { name: 'Estación Saavedra', address: 'Plaza 3400', category: 'culture', lat: -34.558, lon: -58.489, link: '#' },
    { name: 'Parrilla La Uruguaya', address: 'Av. Balbín 4501', category: 'food', lat: -34.561, lon: -58.497, link: '#' }
  ],
  coghlan: [
    { name: 'Estación Coghlan', address: 'Estomba 2600', category: 'culture', lat: -34.562, lon: -58.481, link: '#' },
    { name: 'Hospital Pirovano', address: 'Av. Monroe 3555', category: 'health', lat: -34.566, lon: -58.483, link: '#' },
    { name: 'Plaza Castelli', address: 'Juramento 4800', category: 'culture', lat: -34.563, lon: -58.480, link: '#' },
    { name: 'Club Coghlan', address: 'Nahuel Huapi 4755', category: 'culture', lat: -34.565, lon: -58.493, link: '#' },
    { name: 'Colegio Westminster', address: 'Franklin D. Roosevelt 3849', category: 'education', lat: -34.569, lon: -58.487, link: '#' },
    { name: 'Alianza Francesa (Sede Belgrano)', address: '11 de Septiembre 955', category: 'education', lat: -34.567, lon: -58.450, link: '#' },
    { name: 'La Escondida Parrilla', address: 'Av. Crisólogo Larralde 5099', category: 'food', lat: -34.559, lon: -58.500, link: '#' },
    { name: 'Santa María de los Ángeles', address: 'Dr. Rómulo S. Naón 3250', category: 'education', lat: -34.560, lon: -58.494, link: '#' },
    { name: 'Plaza Gral. Francisco Ramírez', address: 'Franklin D. Roosevelt 4800', category: 'culture', lat: -34.571, lon: -58.497, link: '#' },
    { name: 'Café de la Esquina', address: 'Av. Congreso 3802', category: 'food', lat: -34.564, lon: -58.488, link: '#' }
  ],
};
...
export const virtualToursData: { id: string; videoId: string; durationKey: string; }[] = [];